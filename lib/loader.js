...
function createBot (options = {}) {
  ...
  // Must equal the settings plugin's defaults: on 1.20.2+ node-minecraft-protocol sends this as
  // Client Information during the configuration phase and nothing is re-sent after login.
  options.clientSettings = options.clientSettings ?? plugins.settings.clientInformation(plugins.settings.defaults(options))
